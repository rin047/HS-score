...
# ==========================================
# 3. 核心：文青風質感 A3 橫式 PDF 生成
# ==========================================
st.divider()
st.markdown("### 🖨️ 美化版報表導出中心")

def generate_beautiful_pdf():
...
# 下載按鈕
# ==========================================
all_pdf_data = generate_beautiful_pdf()

st.download_button(
    label="📥 下載所有年級與科目的 A3 橫式美化報表 (PDF)",
    data=all_pdf_data,
    file_name=f"國中各科成績總報表_{selected_year}{selected_month}.pdf",
